...
No Git? Download the [source as a zip](https://github.com/Shaya16/Spent/archive/refs/heads/main.zip), right-click → *Extract All* into your home folder, rename `Spent-main` to `Spent`, then `cd` there.
