...
No Git? Download the [source as a zip](https://github.com/Shaya16/Spent/archive/refs/heads/main.zip) and unzip it. Rename the unzipped folder from `Spent-main` to `Spent` and move it to your home folder, then in Terminal: `cd ~/Spent`.
